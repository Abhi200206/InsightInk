            ...
            {loading ? <Loading /> : <div className="flex justify-center mt-4">
                <div>
                    <div className="flex gap-2 ml-2">
                        ...
                        <input onChange={(e) => setTitle(e.target.value)} className="border-[1px] w-[500px] border-black px-1 rounded" type="text" placeholder="enter the title" />
                    ...
                    <div>
                        <div onClick={submit} className="rounded mx-3 text-white bg-green-500 px-6 text-center h-[30px] cursor-pointer"><p>Create</p></div>
                    </div>
                </div>
            </div>}
        </div>
